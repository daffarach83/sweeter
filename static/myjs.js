function post() {
    let comments = $('#textarea-post').val();
                                                    ...
                                                    <div class="level-left">
                                                        <a class="level-item is-sparta" aria-label="heart" onclick="toggle_like('${post["_id"]}', 'heart')">
                                                            <span class="icon is-small"><i class="fa ${class_heart}"
                                                                    aria-hidden="true"></i></span>&nbsp;<span class="like-num">${post['count_heart']}</span>
                                                        </a>
                                                        ...
                                                        <a class="level-item is-sparta" aria-label="star" onclick="toggle_star('${post["_id"]}', 'star')">
                                                            <span class="icon is-small"><i class="fa ${class_star}"
                                                                    aria-hidden="true"></i></span>&nbsp;<span class="like-num">${post['count_star']}</span>
                                                        </a>
                                                        ...
                                                        <a class="level-item is-sparta" aria-label="thumbsup" onclick="toggle_thumbsup('${post["_id"]}', 'thumbsup')">
                                                            <span class="icon is-small"><i class="fa ${class_thumbsup}"
                                                                    aria-hidden="true"></i></span>&nbsp;<span class="like-num">${post['count_thumbsup']}</span>
                                                        </a>
...
function toggle_thumbsup(post_id, type) {
  ...
  let $i_like = $a_like.find("i");
  if ($i_like.hasClass("fa-thumb-up")) {
    $.ajax({
      type: "POST",
      url: "/update_like",
      data: {
